...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-50 dark:bg-[#060a13] transition-colors duration-300 text-slate-900 dark:text-slate-105">
      ...
      <section id="directory" className="py-24 px-6 sm:px-10 lg:px-16 bg-slate-100/20 dark:bg-slate-900/5 border-t border-slate-200/50 dark:border-slate-800/40">
        <div className="max-w-8xl mx-auto text-center">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-4 text-base leading-relaxed">
              Explore professional insights and guidelines for each critical wellness metric. Click any card to view detailed stages, age ranges, patterns, and medical recommendations.
            </p>
          </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-20 px-6 sm:px-10 lg:px-16 border-t border-slate-850">
        <div className="max-w-8xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16 text-left">
          ...
          <div>
            ...
            <a href="mailto:syahmiklegendry1121@gmail.com" className="text-xs text-blue-400 font-bold hover:underline block mb-5">
              syahmiklegendry1121@gmail.com
            </a>
            <div className="flex gap-3">
              <a href="https://instagram.com/DAILYHEALTH___SK" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-750 transition-all flex items-center justify-center" aria-label="Instagram">
              ...
              <a href="https://x.com/DAILYHEALTH__SK" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-750 transition-all flex items-center justify-center" aria-label="Twitter">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
                </svg>
              </a>
              <a href="https://github.com/syahmiklegendry1121-rgb" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-750 transition-all flex items-center justify-center" aria-label="GitHub">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
